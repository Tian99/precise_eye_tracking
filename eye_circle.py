...
original_image = cv2.imread('input/Eye_tracking.png') # Input file image
edged_image = cv2.imread('output/eye_canny.png', cv2.IMREAD_UNCHANGED) #Input image for the edged image
...
for x, y, r in max_cor:
  ...
  cv2.imwrite('output/eye.png', original_image)
